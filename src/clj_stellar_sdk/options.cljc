...
(defn set
  [{:keys [inflation-destination clear-flags set-flags master-key-weight
           low-threshold medium-threshold high-threshold home-domain
           signer-keypair signer-weight source-account]}]
